...
const PILLARS = [
  ...
  },
  {
    ...
    iconColor: '#4ade80',
    title: 'Direct Sale Split',
    description: 'Every successful referred bundle sale is split instantly by fixed rules.',
    breakdown: [
      { level: 'Your Commission', amount: '₹50', desc: 'Per referred sale' },
      { level: 'Owner Profit', amount: '₹49', desc: 'Per sale retained by admin' },
