        ...
        <div className="glass-card p-8 md:p-12">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="w-full">
              ...
              {/* Level 2 */}
              <div className="text-center mb-3">
                <span className="text-xs font-semibold px-3 py-1 rounded-full" style={{ background: 'rgba(99,102,241,0.2)', color: '#a5b4fc', border: '1px solid rgba(99,102,241,0.3)' }}>Level 2 — ₹2 each</span>
              </div>
              ...
              {/* Level 3 */}
              <div className="text-center mb-3">
                <span className="text-xs font-semibold px-3 py-1 rounded-full" style={{ background: 'rgba(34,211,238,0.1)', color: '#67e8f9', border: '1px solid rgba(34,211,238,0.2)' }}>Level 3 — ₹1 each</span>
              </div>
            ...
            <p className="mt-3 text-sm font-semibold text-white/70">Total: <span className="gradient-text font-bold text-base">₹78</span> from this tree alone</p>
          </div>
        </div>
      </div>
    </section>
