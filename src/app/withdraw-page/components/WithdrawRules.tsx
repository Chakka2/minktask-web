...
const RULES = [
  { id: 'rule-min', icon: IndianRupee, color: '#6366f1', bg: 'rgba(99,102,241,0.12)', title: 'Minimum ₹50', desc: 'You must have at least ₹50 in your wallet to request a withdrawal.' },
    ...
    <div className="space-y-4">
      ...
      <div className="glass-card p-5">
        ...
        <div className="space-y-2">
          {[
            { label: 'Available', value: '₹248.00', color: 'text-white' },
            { label: 'Processing Fee', value: '−₹2.00', color: 'text-red-400' },
            { label: 'Max You Receive', value: '₹246.00', color: 'text-green-400' },
          ]?.map((item) => (
